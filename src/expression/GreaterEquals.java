...
/**
 * A command which tests if one number is greater than or equal to another.
 * Evaluates to a negative number for to false.
 * 0 or a positive numbers means true.
 */
public class GreaterEquals extends LispExpression {

    /**
     * Create a GreaterEquals LispExpression instance.
